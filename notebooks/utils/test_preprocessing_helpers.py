...
from utils.preprocessing_helpers import convert_to_int, row_to_list, preprocess
...
class TestPreprocess(object):
    def test_on_raw_data(self, raw_and_clean_data_file, mocker):
        ...
        convert_to_int_mock = mocker.patch("utils.preprocessing_helpers.convert_to_int",
